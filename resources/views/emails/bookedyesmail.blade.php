...
<div class="flex-center position-ref full-height">
    <div class="content">
        <div class="links">
            ...
            <?php 
                echo "Thank you confirming your cancellation booking for your driving test on ".str_replace('>','',$info[0][0]); 
            ?>
            <p>at Preferred test centre:{{$pct}}</p>
            <p>You will get a confirmation email shortly from DVSA (to the email address you used to book your practical driving test. Its the last bit now until your driving freedom & independance</p>
            <p></p>
            <p>Good Luck!</p>
            <p></p>
            <p>Kind Regards,</p>
